			...
			<div class="row">
				<div class="col-lg-4">
					<div class="card">
						...
						<form action="<?= site_url('private/master_data/biodata/agama_new') ?>" method="POST">
							<div class="card-body">
								...
								<tbody>
									...
									<?php foreach ($agama as $v) : ?>
										<tr>
											...
											<td><?= $v->agama; ?></td>
											<td>
												<a href="<?= base_url('private/master_data/biodata/agama_hapus/' . $v->id_agama) ?>">
