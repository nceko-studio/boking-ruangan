				...
				<div class="col-lg-4">
					<div class="card">
						<div class="card-header">
							<div class="row">
								<div class="col-lg-10">
									<h4 class="card-title">Tambah Status Pegawai</h4>
								</div>
							</div>
						</div>
						<form action="<?= site_url('private/master_data/biodata/status_pegawai_new') ?>" method="POST">
							<div class="card-body">
							...
							<table id="jenjang_tabel" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th style="width: 90%;">Status Pegawai</th>
										<th style="width: 5%;">Aksi</th>
									</tr>
								</thead>
								<tbody>
									<?php $no = 1; ?>
									<?php foreach ($status_pegawai as $v) : ?>
										<tr>
											<td><?= $no++ ?></td>
											<td><?= $v->status_pegawai; ?></td>
											<td>
												<a href="<?= base_url('private/master_data/biodata/status_pegawai_hapus/' . $v->id_status_pegawai) ?>">
													<button class="btn bg-danger btn-xs" title="Hapus Status Pegawai" style="width: 30px;">
