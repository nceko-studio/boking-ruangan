			...
			<div class="row">
				<div class="col-lg-4">
					<div class="card">
						...
						<form action="<?= site_url('private/master_data/ruangan/lantai_new') ?>" method="POST">
							<div class="card-body">
							...
							<table id="jenjang_tabel" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th style="width: 90%;">Lantai</th>
										<th style="width: 5%;">Aksi</th>
									</tr>
								</thead>
								<tbody>
									<?php $no = 1; ?>
									<?php foreach ($lantai as $v) : ?>
										<tr>
											<td><?= $no++ ?></td>
											<td><?= $v->lantai; ?></td>
											<td>
												<a href="<?= base_url('private/master_data/ruangan/lantai_hapus/' . $v->id_lantai) ?>">
													<button class="btn bg-danger btn-xs" title="Hapus Lantai" style="width: 30px;">
