			...
			<div class="row">
				<div class="col-lg-4">
					<div class="card">
						...
						<form action="<?= site_url('private/master_data/ruangan/gedung_new') ?>" method="POST">
							<div class="card-body">
							...
							<table id="jenjang_tabel" class="table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th style="width: 90%;">Gedung</th>
										<th style="width: 5%;">Aksi</th>
									</tr>
								</thead>
								<tbody>
									<?php $no = 1; ?>
									<?php foreach ($gedung as $v) : ?>
										<tr>
											<td><?= $no++ ?></td>
											<td><?= $v->gedung; ?></td>
											<td>
												<a href="<?= base_url('private/master_data/ruangan/gedung_hapus/' . $v->id_gedung) ?>">
													<button class="btn bg-danger btn-xs" title="Hapus Gedung" style="width: 30px;">
