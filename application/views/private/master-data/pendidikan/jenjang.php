			...
			<div class="row">
				<div class="col-lg-4">
					<div class="card">
						...
						<form action="<?= site_url('private/master-data/pendidikan/jenjang_new') ?>" method="POST">
							<div class="card-body">
								...
								<tbody>
									...
									<?php foreach ($jenjang as $v) : ?>
										<tr>
											...
											<td>
												<a href="<?= base_url('private/master-data/pendidikan/jenjang_hapus/' . $v->id_jenjang_pendidikan) ?>">
