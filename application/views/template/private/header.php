...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('assets/private/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') ?>">
	<!-- iCheck -->
	<link rel="stylesheet" href="<?= base_url('assets/private/plugins/icheck-bootstrap/icheck-bootstrap.min.css') ?>">
	<!-- JQVMap -->
	<link rel="stylesheet" href="<?= base_url('assets/private/plugins/jqvmap/jqvmap.min.css') ?>">
	<!-- SweetAlert2 -->
	...
	<!-- overlayScrollbars -->
	<link rel="stylesheet" href="<?= base_url('assets/private/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') ?>">
	<!-- Daterange picker -->
	<link rel="stylesheet" href="<?= base_url('assets/private/plugins/daterangepicker/daterangepicker.css') ?>">
	<!-- summernote -->
	<link rel="stylesheet" href="<?= base_url('assets/private/plugins/summernote/summernote-bs4.min.css') ?>">
</head>
