		...
		<!-- jQuery UI 1.11.4 -->
		<script src="<?= base_url('assets/private/plugins/jquery-ui/jquery-ui.min.js') ?>"></script>
		...
		<!-- ChartJS -->
		<script src="<?= base_url('assets/private/plugins/chart.js/Chart.min.js') ?>"></script>
		<!-- Sparkline -->
		<script src="<?= base_url('assets/private/plugins/sparklines/sparkline.js') ?>"></script>
		<!-- JQVMap -->
		<script src="<?= base_url('assets/private/plugins/jqvmap/jquery.vmap.min.js') ?>"></script>
		<script src="<?= base_url('assets/private/plugins/jqvmap/maps/jquery.vmap.usa.js') ?>"></script>
		<!-- jQuery Knob Chart -->
		<script src="<?= base_url('assets/private/plugins/jquery-knob/jquery.knob.min.js') ?>"></script>
		<!-- daterangepicker -->
		<script src="<?= base_url('assets/private/plugins/moment/moment.min.js') ?>"></script>
		<script src="<?= base_url('assets/private/plugins/daterangepicker/daterangepicker.js') ?>"></script>
		<!-- Tempusdominus Bootstrap 4 -->
		<script src="<?= base_url('assets/private/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') ?>"></script>
		<!-- Summernote -->
		<script src="<?= base_url('assets/private/plugins/summernote/summernote-bs4.min.js') ?>"></script>
		<!-- overlayScrollbars -->
		<script src="<?= base_url('assets/private/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') ?>"></script>
		<!-- SweetAlert2 -->
		...
		<!-- AdminLTE App -->
		<script src="<?= base_url('assets/private/dist/js/adminlte.js') ?>"></script>
		<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
		<script src="<?= base_url('assets/private/dist/js/pages/dashboard.js') ?>"></script>
		</body>
